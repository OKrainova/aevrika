$(function () {
    ...
    $('.nav__toggle').on('click', function(){
       if(!menu.hasClass('open')){ 
            ...
            console.log($(menu).find('.open'));
           $(menu).find('.open').removeClass('open');
        }
    });
        
    $('.dm-toggle').on('click', function(){
        $(this).parent('.dropdown').children('.dropdown-menu').addClass('open');
    });
    
    $('.dropdown-menu__item.back').on('click', function(){
